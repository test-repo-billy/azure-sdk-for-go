...
func (client EndpointKeysClient) GetKeys(ctx context.Context) (result EndpointKeysDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "GetKeys", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "GetKeys", resp, "Failure sending request")
		return
	}

	result, err = client.GetKeysResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "GetKeys", resp, "Failure responding to request")
	}
...
func (client EndpointKeysClient) RefreshKeys(ctx context.Context, keyType string) (result EndpointKeysDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "RefreshKeys", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "RefreshKeys", resp, "Failure sending request")
		return
	}

	result, err = client.RefreshKeysResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.EndpointKeysClient", "RefreshKeys", resp, "Failure responding to request")
	}
