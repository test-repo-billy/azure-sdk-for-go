...
// The returned WorkspacePrivateLinkResourcesServerTransport instance is connected to an instance of armhealthcareapis.WorkspacePrivateLinkResourcesClient via the
...
func NewWorkspacePrivateLinkResourcesServerTransport(srv *WorkspacePrivateLinkResourcesServer) *WorkspacePrivateLinkResourcesServerTransport {
	return &WorkspacePrivateLinkResourcesServerTransport{
		srv:                     srv,
		newListByWorkspacePager: newTracker[azfake.PagerResponder[armhealthcareapis.WorkspacePrivateLinkResourcesClientListByWorkspaceResponse]](),
	}
}

// WorkspacePrivateLinkResourcesServerTransport connects instances of armhealthcareapis.WorkspacePrivateLinkResourcesClient to instances of WorkspacePrivateLinkResourcesServer.
...
type WorkspacePrivateLinkResourcesServerTransport struct {
	...
	newListByWorkspacePager *tracker[azfake.PagerResponder[armhealthcareapis.WorkspacePrivateLinkResourcesClientListByWorkspaceResponse]]
}
...
func (w *WorkspacePrivateLinkResourcesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.Get(req.Context(), resourceGroupNameParam, workspaceNameParam, groupNameParam, nil)
