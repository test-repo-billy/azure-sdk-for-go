...
func (client OperationsClient) GetDetails(ctx context.Context, operationID string) (result Operation, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.OperationsClient", "GetDetails", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.OperationsClient", "GetDetails", resp, "Failure sending request")
		return
	}

	result, err = client.GetDetailsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.OperationsClient", "GetDetails", resp, "Failure responding to request")
	}
