...
// The returned OperationsServerTransport instance is connected to an instance of armhealthcareapis.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armhealthcareapis.OperationsClientListResponse]](),
	}
}

// OperationsServerTransport connects instances of armhealthcareapis.OperationsClient to instances of OperationsServer.
// Don't use this type directly, use NewOperationsServerTransport instead.
type OperationsServerTransport struct {
	srv          *OperationsServer
	newListPager *tracker[azfake.PagerResponder[armhealthcareapis.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armhealthcareapis.OperationsClientListResponse, createLink func() string) {
