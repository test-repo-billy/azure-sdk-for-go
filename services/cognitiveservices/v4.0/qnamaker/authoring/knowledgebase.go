...
func (client KnowledgebaseClient) Create(ctx context.Context, createKbPayload CreateKbDTO) (result Operation, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("authoring.KnowledgebaseClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, createKbPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Create", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Create", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) Delete(ctx context.Context, kbID string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Delete", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) Download(ctx context.Context, kbID string, environment EnvironmentType) (result QnADocumentsDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Download", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Download", resp, "Failure sending request")
		return
	}

	result, err = client.DownloadResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Download", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) GetDetails(ctx context.Context, kbID string) (result KnowledgebaseDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "GetDetails", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "GetDetails", resp, "Failure sending request")
		return
	}

	result, err = client.GetDetailsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "GetDetails", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) ListAll(ctx context.Context) (result KnowledgebasesDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "ListAll", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "ListAll", resp, "Failure sending request")
		return
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "ListAll", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) Publish(ctx context.Context, kbID string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Publish", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Publish", resp, "Failure sending request")
		return
	}

	result, err = client.PublishResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Publish", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) Replace(ctx context.Context, kbID string, replaceKb ReplaceKbDTO) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("authoring.KnowledgebaseClient", "Replace", err.Error())
	}

	req, err := client.ReplacePreparer(ctx, kbID, replaceKb)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Replace", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Replace", resp, "Failure sending request")
		return
	}

	result, err = client.ReplaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Replace", resp, "Failure responding to request")
	}
...
func (client KnowledgebaseClient) Update(ctx context.Context, kbID string, updateKb UpdateKbOperationDTO) (result Operation, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.KnowledgebaseClient", "Update", resp, "Failure responding to request")
	}
