...
func (client AlterationsClient) Get(ctx context.Context) (result WordAlterationsDTO, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Get", resp, "Failure responding to request")
	}
...
func (client AlterationsClient) Replace(ctx context.Context, wordAlterations WordAlterationsDTO) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("authoring.AlterationsClient", "Replace", err.Error())
	}

	req, err := client.ReplacePreparer(ctx, wordAlterations)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Replace", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Replace", resp, "Failure sending request")
		return
	}

	result, err = client.ReplaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "authoring.AlterationsClient", "Replace", resp, "Failure responding to request")
	}
